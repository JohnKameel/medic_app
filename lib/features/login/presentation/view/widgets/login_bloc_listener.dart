...
import 'package:medic_app/features/login/presentation/view_model/login_state.dart';
  ...
  void setupErrorState(BuildContext context, String error) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(error, style: AppStyle.font15DarkBlueMedium,),
        actions: [
          TextButton(
            onPressed: () => context.pop(),
            child: Text('OK', style: AppStyle.font14BlueSemiBold,),
          ),
        ],
      ),
    );
